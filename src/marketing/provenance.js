...
//   observed     read directly from a recorded field (e.g. the order's sales channel, exported sessions)
...
export const EVIDENCE_KINDS = ['observed', 'attributed', 'inferred', 'unavailable'];
export const NOT_CAUSAL = 'ATTRIBUTION_IS_NOT_CAUSAL_PROOF';

export function provenance({ source_system, attribution_model = null, fields = [], window = null, limitations = [], completeness, evidence_kind }) {
  ...
  return {
    source_system, attribution_model, source_fields: fields, window,
