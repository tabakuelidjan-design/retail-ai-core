...
export async function startApp(o = {}) {
  ...
  const app = createFinanceApp({
    ...
    lookupProviders: o.lookupProviders, companySearchProvider: o.companySearchProvider, companyRegistry: o.companyRegistry, priceSource: o.priceSource, stockApplier: o.stockApplier, mailAdapter: o.mailAdapter, accessPoint: o.accessPoint,
  });
