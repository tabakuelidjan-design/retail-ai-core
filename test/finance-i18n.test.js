...
const NOT_UI = new Set(['Content-Type', 'X-CSRF-Token', 'UI error:', 'currentColor', '--accent', 'var(--line)', 'Enter', 'ArrowDown', 'ArrowUp', 'Escape', 'image/png,image/jpeg', 'image/', 'application/pdf', 'pack.json', '60_plus', 'accounts@company.example', 'INV-2026-0001', '_MISSING', '_blank', 'YYYY-MM-DD']);
